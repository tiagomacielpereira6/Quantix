...
class ProveedorController extends Controller
{
    ...
    public function store(Request $request)
    {
        $request->validate([
            ...
            'telefono' => 'required|string|max:20|unique:proveedores,telefono',
    ...
    public function update(Request $request, Proveedor $proveedor)
    {
        $request->validate([
            'nombre' => 'required|string|max:255',
            'contacto' => 'nullable|string|max:255',
            'telefono' => 'required|string|max:20|unique:proveedores,telefono,' . $proveedor->id_proveedor . ',id_proveedor',
            'correo' => 'nullable|email|max:255|unique:proveedores,correo,' . $proveedor->id_proveedor . ',id_proveedor',
            'direccion' => 'nullable|string|max:500'
        ]);
