    ...
    <div class="recibo">
        ...
        <div class="header">
            <div class="logo-section">
                <div class="logo">🍔 CARRITO COMIDA RÁPIDA</div>
                <div class="empresa-info">
                    ...
                    <div><strong>Email:</strong> info@carritocomida.com</div>
                </div>
            </div>
        ...
        <div class="footer">
            ...
            <div>Para consultas: info@carritocomida.com | +54 9 123 456-7890</div>
            <div style="margin-top: 15px;">
                <strong>Siguenos en nuestras redes sociales:</strong><br>
                FB: /CarritoComidaRapida | IG: @carritocomida
            </div>
